          ...
          <Card>
            <CardContent className="p-4">
              <div className="space-y-2">
                ...
                <div className="break-all rounded-md bg-muted p-2 text-xs font-mono">{walletAddress}</div>
              </div>
            </CardContent>
          </Card>

          <Button className="w-full" onClick={() => onComplete({ walletAddress })} disabled={isLoading}>
